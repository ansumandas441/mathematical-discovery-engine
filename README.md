...
| 10 | [`10_toolbox.md`](10_toolbox.md) | cross-cutting | Structured toolbox: Mermaid tree of 27 techniques, function-style dictionary, inheritance graph, decision flowchart, quick-reference table |
